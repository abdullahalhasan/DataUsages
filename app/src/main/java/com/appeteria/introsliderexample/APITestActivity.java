...
public class APITestActivity extends AppCompatActivity {
    ...
    String URL_HISTORY = "http://www.mindscape.com.bd/api/v1/location/history";
    String URL_USAGE = "http://www.mindscape.com.bd/api/v1/data/usage";
    ...
    private void locationUpdate() {
        ...
        objRequest = new JsonObjectRequest(Request.Method.POST, URL_HISTORY,postObject,
